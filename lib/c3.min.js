/* @license C3.js v0.5.2 | (c) C3 Team and other contributors | http://c3js.org/ */ ! function (t, e) {
    ...
    function w(t, e) {
        ...
        return (!o || o <= 0) && (o = r.isVertical() ? 95 : r.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110),
            function t(e, s) {
                n = void 0;
    ...
    return A.generate = function (t) {
    ...
    }, b = A.chart.fn, (T = A.chart.internal.fn).beforeInit = function () {}, T.afterInit = function () {}, T.init = function () {
        var t = this,
            e = t.config;
        ...
        var e = this,
            ...
            a = e.d3;
        return function () {
            var r, s, o, c, d, u, l, h, g, p, _, x = t.targets,
                y = t.flow,
                m = t.drawBar,
                S = t.drawLine,
                w = t.drawArea,
        ...
        var e, i, n, a, r, s = this,
            ...
            u = "",
            l = s.hasType("gauge");
        if (d && !l) e = this.svgArc.centroid(d), i = isNaN(e[0]) ? 0 : e[0], n = isNaN(e[1]) ? 0 : e[1], a = Math.sqrt(i * i + n * n), u = "translate(" + i * (r = s.hasType("donut") && c.donut_label_ratio ? o(c.donut_label_ratio) ? c.donut_label_ratio(t, s.radius, a) : c.donut_label_ratio : s.hasType("pie") && c.pie_label_ratio ? o(c.pie_label_ratio) ? c.pie_label_ratio(t, s.radius, a) : c.pie_label_ratio : s.radius && a ? (36 / s.radius > .375 ? 1.175 - 36 / s.radius : .8) * s.radius / a : 0) + "," + n * r + ")";
        ...
        return this.convertXsvToData(t, this.d3.csvParse)
    }, T.convertTsvToData = function (t) {
        return this.convertXsvToData(t, this.d3.tsvParse)
        ...
        for (var e = [], i = 0; i < t.length; i++)
            for (var n = t[i][0], a = 1; a < t[i].length; a++) {
                if (u(e[a - 1]) && (e[a - 1] = {}), u(t[i][a])) throw new Error("Source data is missing a component at (" + i + "," + a + ")!");
                e[a - 1][n] = t[i][a]
            }
        return e
        ...
        return r.forEach(function (i) {
            ...
            })) : a.data_x ? n.data.xs[i] = n.getOtherTargetXs() : _(a.data_xs) && (n.data.xs[i] = n.getXValuesOfXKey(r, n.data.targets)) : n.data.xs[i] = t.map(function (t, e) {
                return e
            })
            ...
            return {
                ...
                values: t.map(function (t, s) {
                    var o, c = t[n.getXKey(e)],
                        d = null === t[e] || isNaN(t[e]) ? null : +t[e];
                    return n.isCustomX() && n.isCategorized() && !u(c) ? (0 === i && 0 === s && (a.axis_x_categories = []), -1 === (o = a.axis_x_categories.indexOf(c)) && (o = a.axis_x_categories.length, a.axis_x_categories.push(c))) : o = n.generateTargetX(c, e, s), (u(t[e]) || n.data.xs[e].length <= s) && (o = void 0), {
                        x: o,
                        value: d,
                        id: r
                    }
        ...
        var n, a, r, o, c, d, u, l, h, g, p = this,
            x = p.config,
        ...
        u.hasArcType() || l.data_selection_enabled && l.data_selection_multiple && (e = u.dragStart[0], n = u.dragStart[1], a = t[0], r = t[1], s = Math.min(e, a), o = Math.max(e, a), c = l.data_selection_grouped ? u.margin.top : Math.min(n, r), d = l.data_selection_grouped ? u.height : Math.max(n, r), h.select("." + i.dragarea).attr("x", s).attr("y", c).attr("width", o - s).attr("height", d - c), h.selectAll("." + i.shapes).selectAll("." + i.shape).filter(function (t) {
            ...
            var n, a, r, l, h, f, p = g.select(this),
                _ = p.classed(i.SELECTED),
                x = p.classed(i.INCLUDED),
                y = !1;
            if (p.classed(i.circle)) n = 1 * p.attr("cx"), a = 1 * p.attr("cy"), h = u.togglePoint, y = s < n && n < o && c < a && a < d;
            else {
        ...
        var n, a, r, s, o = [],
            c = this.main.select("." + i.axisX).selectAll(".tick").size();
        if ("year" === t)
            for (a = (n = this.getXDomain())[0].getFullYear(), r = n[1].getFullYear(), s = a; s <= r; s++) o.push(new Date(s + "-01-01 00:00:00"));
        ...
        var a, r, s, o, c, d, u, h, g, f, p, _, y, m, S, w, v = this,
            b = v.config,
            T = 4,
            A = 10,
            P = 0,
        ...
        var e = this,
            n = e.main.selectAll("." + i.lines).selectAll("." + i.line).data(e.lineData.bind(e)),
        ...
        var a, r, s, o, c, d, h, g, f, p, _, x = this,
            y = x.config,
            m = "M",
        ...
        if (l(n))
            for (a = 0; a < n.length; a++) w[a] = {}, u(n[a].start) ? w[a].start = t[0].x : w[a].start = x.isTimeSeries() ? x.parseDate(n[a].start) : n[a].start, u(n[a].end) ? w[a].end = t[t.length - 1].x : w[a].end = x.isTimeSeries() ? x.parseDate(n[a].end) : n[a].end;
        ...
        for (p = y.axis_rotated ? function (t) {
            ...
            if (u(w) || !v(t[a].x, w)) m += " " + p(t[a]) + " " + _(t[a]);
                ...
                for (o = x.getScale(t[a - 1].x + S, t[a].x + S, x.isTimeSeries()), c = x.getScale(t[a - 1].value, t[a].value), d = e(t[a].x) - e(t[a - 1].x), h = i(t[a].value) - i(t[a - 1].value), f = 2 * (g = 2 / Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2))), r = g; r <= 1; r += f) m += s(t[a - 1], t[a], r, g);
            t[a].x
        }
        return m
        ...
        var e = this,
            n = e.d3,
            a = e.main.selectAll("." + i.areas).selectAll("." + i.area).data(e.lineData.bind(e)),
        ...
        var n = this,
            a = n.main.selectAll("." + i.circles).selectAll("." + i.circle).data(n.lineOrScatterData.bind(n)),
        ...
        var e = this,
            n = e.context.selectAll("." + i.bars).selectAll("." + i.bar).data(e.barData.bind(e)),
        ...
        var e = this,
            n = e.context.selectAll("." + i.lines).selectAll("." + i.line).data(e.lineData.bind(e)),
            a = n.enter().append("path").attr("class", e.classLine.bind(e)).style("stroke", e.color);
        ...
        var e = this,
            n = e.d3,
            a = e.context.selectAll("." + i.areas).selectAll("." + i.area).data(e.lineData.bind(e)),
            r = a.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function () {
                return e.orgAreaOpacity = +n.select(this).style("opacity"), 0
            });
        ...
        for (p && t.sort(p), r = 0; r < t.length; r++)
            if (t[r] && (t[r].value || 0 === t[r].value) && (a || (s = m(h ? h(t[r].x) : t[r].x), a = "<table class='" + u.CLASS.tooltip + "'>" + (s || 0 === s ? "<tr><th colspan='2'>" + s + "</th></tr>" : "")), void 0 !== (o = m(f(t[r].value, t[r].ratio, t[r].id, t[r].index, t))))) {
